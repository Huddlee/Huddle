...
public class SecurityConfig {
    ...
    @Bean
    public UserHandshakeInterceptor userHandshakeInterceptor() {
        return new UserHandshakeInterceptor(jwtUtils);
    }
    ...
    // 3. Define the CORS configuration bean for development
    @Bean
